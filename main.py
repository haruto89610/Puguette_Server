...
from Gaits.Walk import xratio, xPoints, zPoints
...
def main():
    ...
    coords = np.array([[0.00, -0.03, -0.45],
                       [0.00,  0.03, -0.45],
                       [0.00, -0.03, -0.45],
                       [0.00,  0.03, -0.45]])
...
#                    i+=1
            ...
            if speed != 0 or angle != 0:
                if T <= 0:
                    ...
                    coords[1][0], coords[1][2] = ((-xPoints[11]/xratio)+(xPoints[0]/xratio))*T+xPoints[11]/xratio, -0.45 #FL
                    coords[2][0], coords[2][2] = ((xPoints[11]/xratio)-(xPoints[0]/xratio))*T+xPoints[0]/xratio, -0.45 #BR
                    ...
                    coords[0][0], coords[0][2] = ((-xPoints[11]/xratio)+(xPoints[0]/xratio))*(T-1)+xPoints[11]/xratio, -0.45
                    coords[3][0], coords[3][2] = ((xPoints[11]/xratio)-(xPoints[0]/xratio))*(T-1)+xPoints[0]/xratio, -0.45
